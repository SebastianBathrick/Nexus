...
public class LexerTests
{
    ...
    {
        var tokens = Lexer.Lex("hello").ToList();
    ...
    {
        var tokens = Lexer.Lex("_hello").ToList();
        Assert.That(tokens.Count, Is.EqualTo(1));
        Assert.That(tokens[0].Type, Is.EqualTo(TokenType.Identifier));
    ...
    {
        var tokens = Lexer.Lex("hello123").ToList();
        Assert.That(tokens.Count, Is.EqualTo(1));
        Assert.That(tokens[0].Type, Is.EqualTo(TokenType.Identifier));
    ...
    {
        var tokens = Lexer.Lex("_my_var_1").ToList();
        Assert.That(tokens.Count, Is.EqualTo(1));
        Assert.That(tokens[0].Type, Is.EqualTo(TokenType.Identifier));
    ...
    {
        var tokens = Lexer.Lex("123abc").ToList();
    ...
    {
        var tokens = Lexer.Lex("foo bar").ToList();
    ...
    public void Lex_ReservedKeyword_ReturnsKeywordToken(string keyword)
    {
        ...
        var tokens = Lexer.Lex(keyword).ToList();
        Assert.That(tokens.Count, Is.EqualTo(1));
    ...
    {
        var tokens = Lexer.Lex("_" + keyword).ToList();
        Assert.That(tokens.Count, Is.EqualTo(1));
        Assert.That(tokens[0].Type, Is.EqualTo(TokenType.Identifier));
    }
    ...
    {
        var tokens = Lexer.Lex(keyword + "x").ToList();
        Assert.That(tokens.Count, Is.EqualTo(1));
        Assert.That(tokens[0].Type, Is.EqualTo(TokenType.Identifier));
    }
    ...
    {
        var expectedType = LanguageSpecifications.ReservedKeywords[keyword];
        var tokens = Lexer.Lex(keyword + " myVar").ToList();
        Assert.That(tokens.Count, Is.EqualTo(2));
        Assert.That(tokens[0].Type, Is.EqualTo(expectedType));
        Assert.That(tokens[1].Type, Is.EqualTo(TokenType.Identifier));
    ...
    public void Lex_ValidOperator_ReturnsCorrectOperatorToken(string op)
    {
        ...
        var tokens = Lexer.Lex(op).ToList();
        Assert.That(tokens.Count, Is.EqualTo(1));
        Assert.That(tokens[0].Type, Is.EqualTo(expectedType));
    }
    ...
    {
        var tokens = Lexer.Lex("a+b").ToList();
    ...
    {
        var tokens = Lexer.Lex("1+2").ToList();
        Assert.That(tokens.Count, Is.EqualTo(3));
        Assert.That(tokens[0].Type, Is.EqualTo(TokenType.NumberLiteral));
        Assert.That(tokens[1].Type, Is.EqualTo(TokenType.SymbolPlus));
    ...
    {
        var tokens = Lexer.Lex("42").ToList();
        Assert.That(tokens.Count, Is.EqualTo(1));
        Assert.That(tokens[0].Type, Is.EqualTo(TokenType.NumberLiteral));
    ...
    {
        var tokens = Lexer.Lex("3.14").ToList();
        Assert.That(tokens.Count, Is.EqualTo(1));
        Assert.That(tokens[0].Type, Is.EqualTo(TokenType.NumberLiteral));
